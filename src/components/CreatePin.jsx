...
const CreatePin = ({ user }) => {
    ...
    const uploadImage = (e) => {
        ...
        if (
            seletedFile.type === 'image/png' ||
            seletedFile.type === 'image/svg' ||
            seletedFile.type === 'image/jpeg' ||
            seletedFile.type === 'image/gif'
        ) {
            setWrongImageType(false);
            setLoading(true);
            client.assets
                .upload('image', seletedFile, { contentType: seletedFile.type, filename: seletedFile.name })
                .then((document) => {
